...
import TableClientes from '../../../components/tables/cliente/TableCliente'

import DashboardClienteService from '../../../app/services/cliente/DashboardClienteService'
...
class DashboardCliente extends React.Component {
            ...
            <div className="card card-pesquisa">
                ...
                <div className="row pt-4">
                    <div className="col-md-12">
                        <div className="bs-component">
                            <TableClientes pesquisaClient={this.state.clientes} deleteAction={this.abrirConfirmacao} editAction={this.editar}/>
                        </div>
                    </div>
                    <div>
